...
import {
  ChevronDown, Plus, Settings, Users, Check,
} from 'lucide-react';
...
export const WorkspaceSwitcher: React.FC = () => {
  const { workspaces, currentWorkspace, setCurrentWorkspace, createWorkspace, fetchWorkspaces } =
    useWorkspaceStore();
          ...
          <div className="max-h-48 overflow-y-auto">
            {workspaces.map((ws) => (
              <button
                ...
                className="flex items-center gap-2.5 px-3 py-2 w-full hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors"
              >
                <div
